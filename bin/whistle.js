...
program
  ...
  .option('-H, --host [host]', 'set the bind host of proxy server (INADDR_ANY by default)', String, undefined)
  .option('-p, --port [port]', 'set the port of proxy server (' + config.port + ' by default)', parseInt, undefined)
  .option('--reversePort [reversePort]', 'set the port of reverse proxy server', parseInt, undefined)
