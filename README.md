...
打开 [http://127.0.0.1:9527/](http://127.0.0.1:9527/)（9527为对应的代理端口号，如果是0.0.18及以上的版本，可以直接访问：[http://local.whistlejs.com/](http://local.whistlejs.com/)）可以开始配置各种hosts。

###hosts功能###

whistle对系统的hosts功能进行了扩展，支持原有hosts功能的基础上增加了http转https、请求转发、端口转发、本地文件替换、并集成了天马及独角兽的功能、且支持正则匹配等（#为注释）		
