...
> 当前whistle的最新版本为[v1.0.4](https://github.com/avwo/whistle/blob/master/CHANGELOG.md#-)，为确保使用whistle所有功能，请及时[更新whistle](https://whistle.gitbooks.io/help/content/update.html)
