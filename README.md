...
> 老用户建议升级到最新版本，并启动时添加参数 `w2 restart -A` 重新生成根证书并[安装](https://avwo.github.io/whistle/webui/https.html)，否则在Mac上最新版本的Chrome的Https拦截功能将无法使用，更多内容参考: [#44](https://github.com/avwo/whistle/issues/44)
