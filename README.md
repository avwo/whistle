...
> 当前whistle的最新版本为[v1.4.17](https://github.com/avwo/whistle/blob/master/CHANGELOG.md#-)，确保能使用whistle的所有功能，尽量使用最新版本的whistle，虽然whistle基本上支持Node的所有版本，但建议使用使用 `v6` 及以上版本，否则性能及在Chrome或APP上[抓包HTTPS请求](https://avwo.github.io/whistle/webui/https.html)会有问题。
