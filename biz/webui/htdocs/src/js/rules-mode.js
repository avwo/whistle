...
CodeMirror.defineMode('rules', function() {
  ...
  function isProxy(str) {
    return /^(?:proxy|http-proxy|http2https-proxy|https2http-proxy|internal-proxy):\/\//.test(str);
  }
