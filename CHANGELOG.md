...
1. json对象的一种inline写法，可以直接写在协议的uri里面，形如：`protocol://name1:values|name2:value2|name3|name4:|name5:value5|nameN:valueN` 或 `protocol://name1=values&name2=value2&name3&name4=&name5=value5&nameN=valueN`
