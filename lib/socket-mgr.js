...
exports.handleConnect = function(req, res) {
  ...
  if (hasEvent || isConn) {
    ...
    if (customInspect || !isConn) {
      ...
      handleInspect = (customInspect || !isConn) && function(chunk, encoding, cb) {
...
exports.handleWebsocket = function(req, res) {
  ...
  var customInspect = !req.pluginServerPort && req.customInspect;
  var reqId = req.reqId;
  var sendStatus = { data: [] };
