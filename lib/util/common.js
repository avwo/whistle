...
function onReadEnd(stream, callback) {
...
function onWriteEnd(stream, callback) {
...
exports.onReadEnd = onReadEnd;
exports.onWriteEnd = onWriteEnd;
...
exports.onSocketEnd = function(socket, callback) {
  ...
  if (socket.aborted || socket.destroyed || socket.closed || socket._hasError) {
    return execCallback();
  }
...
exports.connectInner = function (options, cb, config) {
  ...
  req = httpModule.request(proxyOptions);
