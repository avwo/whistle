...
exports.PATTERN_HEADER = 'x-whistle-raw-pattern_';
exports.HOST_IP_HEADER = 'x-whistle-host-ip';
exports.CERT_CACHE_INFO = 'x-whistle-cert-cache-info';
exports.COMMON_NAME_HEADER = 'x-whistle-common-name';
exports.FULL_URL_HEADER = 'x-whistle-full-url';
exports.REAL_URL_HEADER = 'x-whistle-real-url';
exports.SERVER_NAME_HEADER = 'x-whistle-server-name';
exports.GLOBAL_VALUE_HEADER = 'x-whistle-global-value';
exports.METHOD_HEADER = 'x-whistle-method';
exports.RELATIVE_URL_HEADER = 'x-whistle-relative-url';
exports.RULE_VALUE_HEADER = 'x-whistle-rule-value';
exports.RULE_PROTO_HEADER = 'x-whistle-rule-proto';
exports.SNI_VALUE_HEADER = 'x-whistle-sni-value';
exports.RULE_URL_HEADER = 'x-whistle-rule-url';
exports.REQ_ID_HEADER = 'x-whistle-req-id';
exports.PIPE_VALUE_HEADER = 'x-whistle-pipe-value';
exports.CUSTOM_PARSER_HEADER = 'x-whistle-frame-parser';
exports.STATUS_CODE_HEADER = 'x-whistle-status-code';
exports.HOST_VALUE_HEADER = 'x-whistle-local-host';
exports.PROXY_VALUE_HEADER = 'x-whistle-proxy-value';
exports.PAC_VALUE_HEADER = 'x-whistle-pac-value';
exports.CLIENT_IP_HEADER = 'x-forwarded-for';
exports.EXTRA_URL_HEADER = 'x-whistle-extra-url';
...
var FLAGS_HEADER = 'x-whistle-flags-5b6af7b-9884e1165_';
var FLAGS = ['_existsCustomCert', '_enableCapture', '_isUpgrade', '_noDecompress',
  '_isUIRequest', 'fromTunnel', 'fromComposer', 'isPluginReq', 'enableXFF', '_sniType',
  'clientIp', 'clientPort', '_remoteAddr', '_remotePort'];

exports.setFlags = function(req, headers) {
  var last = FLAGS.length - 5;
  var result = [];
  ...
  if (req._sniType) {
    result[last] = req._sniType;
  }
  if (req.clientIp) {
    result[last + 1] = req.clientIp;
  }
  if (req.clientPort) {
    result[last + 2] = req.clientPort;
  }
  result[last + 3] = req._remoteAddr || LOCALHOST;
  result[last + 4] = req._remotePort || '0';
  result = result.join(',');
  if (result) {
    headers[FLAGS_HEADER] = result;
  } else {
    delete headers[FLAGS_HEADER];
  }
};

exports.getFlags = function(headers) {
  var flags = headers[FLAGS_HEADER];
  var result = {};
  delete headers[FLAGS_HEADER];
  if (!isString(flags)) {
    return result;
