...
module.exports = function parseReq(socket, callback, readBuffer, neadModifyHeaders) {
  ...
  function parseData(data) {
    ...
    req.rawHeaderNames = getRawHeaderNames(parsePairs(headers, rawHeaders));
    ...
    if (neadModifyHeaders) {
      req.getBuffer = function(headers, path) {
        ...
        headers = formatHeaders(headers, req.rawHeaderNames);
        var rawData = [path || firstLine, getRawHeaders(headers)];
