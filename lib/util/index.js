...
function isCustomInspect(req) {
  var enable = req.enable || '';
  return enable.customInspect || enable.customParser || enable.customFrame;
}
exports.isCustomInspect = isCustomInspect;

exports.getInspectStatus = function(req) {
  if (!req.pluginServerPort || !isCustomInspect(req)) {
    return;
  }
  var enable = req.enable;
  var customInspect = ['inspect'];
  if (enable.pauseSend) {
