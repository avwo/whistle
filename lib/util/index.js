...
exports.getWebWoker = function(conf) {
  var webWorker = conf.webWorker;
  return isString(webWorker) && webWorker.length <= 120 ? webWorker : undefined;
};
...
exports.parseDelQuery = parseDelQuery;
...
exports.deleteReqHeaders = function (req) {
  var delReqHeaders = parseDelProps(req).reqHeaders;
  var headers = req.headers;
