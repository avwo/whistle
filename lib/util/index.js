...
function showPluginHosts(req, rulesMgr) {
	if (req.rules.host || !rulesMgr) {
		return;
	}
	
	var rules = rulesMgr.resolveRules(req.fullUrl);
	if (rules.host) {
		req.rules.host = rules.host;
	}
}

exports.showPluginHosts = showPluginHosts;
