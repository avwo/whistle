...
function isEnableH2(req) {
  var enable = req.enable || '';
  return enable.h2 || enable.http2;
}

function isDisableH2(req) {
  var disable = req.disable || '';
  return disable.h2 || disable.http2;
}

exports.isEnableH2 = function(req) {
  return isEnableH2(req) && !isDisableH2(req);
};
exports.isDisableH2 = function(req) {
  return isDisableH2(req) && !isEnableH2(req);
};
