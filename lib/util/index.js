...
var cpus = os.cpus();
var addressList = [];
var interfaceData = [hostname, os.platform(), os.release(),
  ...
  for (var i in interfaces) {
    ...
    if (Array.isArray(list)) {
      list.forEach(function(info) {
        ...
        interfaceData.push(info.address);
      });
    }
  }
...
var clientId = config.clientId = crypto.createHmac('sha256', 'x-whistle-client-id')
