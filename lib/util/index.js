...
var CLIENT_INFO_HEADER = 'x-whistle-client-info-' + uid;
...
exports.CLIENT_INFO_HEADER = CLIENT_INFO_HEADER;
...
function getForwardedFor(headers) {
  var ip = getClientIpFH(headers, config.CLIENT_IP_HEADER);
...
exports.getRemotePort = function (req) {
  return common.getRemotePort(req, config);
};
...
exports.setFlagHeader = function (headers, flag, key) {
  if (flag) {
    headers[key] = '1';
  } else {
    delete headers[key];
...
exports.transformReq = function(req, res, port, host, html) {
  ...
  if (req.clientIp || !net.isIP(headers[config.CLIENT_IP_HEADER])) {
    var clientIp = req.clientIp || getClientIp(req);
    if (isLocalAddress(clientIp)) {
      delete headers[config.CLIENT_IP_HEADER];
    } else {
...
exports.parseClientInfo = function (req) {
  var clientInfo = req.headers[CLIENT_INFO_HEADER] || '';
  ...
  if (clientInfo) {
    delete req.headers[CLIENT_INFO_HEADER];
