...
var WHISTLE_PATH = process.env.WHISTLE_PATH || path.join(__dirname, '../../../');
var OLD_LOCAL_DATA_PATH = exports.OLD_LOCAL_DATA_PATH = path.join(WHISTLE_PATH, '.whistle data');
var LOCAL_DATA_PATH = exports.LOCAL_DATA_PATH = path.join(WHISTLE_PATH, config.dataDirname);
