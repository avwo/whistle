...
module.exports = function(req, res, next) {
  ...
  // req.curUrl = req.fullUrl = util.getFullUrl(req);
  // const hasReqBodyFilter = rules.resolveReqBodyFilter(req);
  // console.log('reqqqqqqqqq', !!hasReqBodyFilter);
  // const hasResBodyFilter = rules.resolveResBodyFilter(req);
  // console.log('resssssssss', !!hasResBodyFilter);
