...
function getDecoder(obj, req) {
  return function(socket, callback) {
    ...
    if (socket || encoding !== newEncoding || enableGzip(req)) {
    ...
    var decoder = obj._hasZipBody && encoding && util.getUnzipStream(encoding);
...
function getEncoder(obj, req) {
  return function(socket, callback) {
    ...
    var encoder = type && util.getZipStream(type);
...
module.exports = function(req, res, next) {
  ...
  pluginMgr.resolvePipePlugin(req, function() {
    if (req._pipePluginPorts.reqReadPort || req._pipePluginPorts.reqWritePort) {
