...
module.exports = function(req, res, next) {
  ...
  req.onDecode = function(callback) {
    pluginMgr.getReqDecoder(req, callback);
  };
  req.onEncode = function(callback) {
    pluginMgr.getReqEncoder(req, callback);
  };
  res.onDecode = function(callback) {
    pluginMgr.getResDecoder(req, res, callback);
  };
  res.onEncode = function(callback) {
    pluginMgr.getResEncoder(req, res, callback);
  };
