...
function handleUrlParams(req, urlParams) {
	if (urlParams) {
...
module.exports = function(req, res, next) {
	...
	util.parseRuleJson([reqRules.req, reqRules.reqHeaders], 
		...
		util.readInjectFiles(data, function(data) {
			...
			util.parseRuleJson([reqRules.reqCookies, reqRules.auth, reqRules.urlParams, reqRules.params, reqRules.reqCors], 
