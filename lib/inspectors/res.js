                  ...
                  if (
                    ...
                    if (isProxyPort && util.isLocalAddress(ip)) {
                      ...
                      if (!util.isLocalAddress(req.clientIp)) {
                        proxyHeaders[config.CLIENT_IP_HEADER] = req.clientIp;
                      }
                      ...
                      var opts = {
                        ...
                        proxyServername: isHttpsProxy
                          ...
                          : null,
                        proxyHost: ip,
                        clientIp: proxyHeaders[config.CLIENT_IP_HEADER],
                        proxyPort: proxyPort,
                        url: options.href,
                ...
                function request(options, serverPort, direct) {
                  ...
                  if (req.disable.clientIp || req.disable.clientIP) {
                    ...
                    if (net.isIP(forwardedFor)) {
                      ...
                      headers[config.CLIENT_IP_HEADER] = req._customXFF;
                    } else if (
                      (!options.isPlugin &&
                        !req.enable.clientIp &&
                        !req.enable.clientIP &&
                      ...
                      headers[config.CLIENT_IP_HEADER] = req.clientIp;
                    }
                  }
