      ...
      rules.resolveHost(req, function(err, ip, port, host) {
        ...
        if (proxyUrl) {
          ...
          if (isHttps || isSocks || isHttpsProxy || req._phost) {
            isProxyPort = proxyPort == config.port || proxyPort == config.httpsPort;
        ...
        isProxyPort = curPort == config.port || curPort == config.httpsPort || curPort == config.httpPort;
