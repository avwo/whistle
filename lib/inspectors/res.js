...
module.exports = function(req, res, next) {
	...
	res.response = function(_res) {
		...
		util.getFileWriters([util.hasBody(_res) ? getWriterFile(util.getRuleFile(resRules.resWrite), statusCode) : null, 
				getWriterFile(util.getRuleFile(resRules.resWriteRaw), statusCode)] : null, function(writer, rawWriter) {
