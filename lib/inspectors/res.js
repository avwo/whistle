          ...
          rules.resolveHost(req, function(err, ip, port, hostRule) {
            ...
            function request(options, serverPort, direct) {
              ...
              if (req.disable.clientIp || req.disable.clientIP) {
                ...
                } else if ((!options.isPlugin && !req.enable.clientIp &&
                  !req.enable.clientIP && !req.enableXFF && (isHttps || isSocks || !proxyUrl)) ||
          ...
          util.parseRuleJson(ruleList, function(headers, cookies, cors, replacement, params, newTrailers) {
            ...
            util.readInjectFiles(data, function(data) {
              ...
              function(resBody, resPrepend, resAppend, htmlAppend, jsAppend, cssAppend,
                ...
                if (hasData) {
                  !enable.keepAllCSP && !enable.keepCSP && util.disableCSP(headers);
                  !req._customCache && !enable.keepCache && util.disableResStore(headers);
                }
                ...
                util.getFileWriters([bodyFile, rawFile], function(writer, rawWriter) {
                  ...
                  util.delay(util.getMatcherValue(resRules.resDelay), function() {
                    ...
                    if (req.filter.showHost || enable.showHost) {
                    ...
                    try {
                      ...
                      if (res.flushHeaders && (!req.disable.flushHeaders || enable.flushHeaders)) {
                        res.flushHeaders();
                      }
                    } catch(e) {
