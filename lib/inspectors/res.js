              ...
              function(resBody, resPrepend, resAppend, htmlAppend, jsAppend, cssAppend,
                ...
                util.getFileWriters([bodyFile, rawFile], function(writer, rawWriter) {
                  ...
                  _res.on('end', function() {
                    if (res.chunkedEncoding && !req.disable.trailers && !req.disable.trailer && util.notEmptyObject(_res.trailers)) {
                      try {
                        var rawHeaderNames = getRawHeaderNames(_res.rawTrailers);
                        res.setCurTrailers && res.setCurTrailers(_res.trailers, rawHeaderNames);
                        res.addTrailers(formatHeaders(_res.trailers, rawHeaderNames));
                      } catch (e) {}
                    }
                  });
