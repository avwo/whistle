    ...
    readFirstChunk(req, function() {
      ...
      rules.getClientCert(req, function(key, cert, isPfx, cacheKey) {
        rules.getProxy(options.href, options.isPlugin ? null : req, function(err, hostIp, hostPort) {
          ...
          if (req._urlParams || req._urlReplace) {
            var newUrl = options.href;
            if (req._urlParams) {
              newUrl = util.replaceUrlQueryString(newUrl, req._urlParams);
            }
            if (req._urlReplace) {
              newUrl = util.parsePathReplace(newUrl, req._urlReplace);
            }
            if (newUrl !== options.href) {
              newUrl = util.parseUrl(newUrl);
              options.path = newUrl.path;
              options.pathname = newUrl.pathname;
              options.href = newUrl.href;
              options.search = newUrl.search;
              options.query = newUrl.query;
              req.realUrl = res.realUrl = newUrl.href;
            }
          }
          if (!hostIp) {
          ...
          rules.resolveHost(req, function(err, ip, port, host) {
            ...
            function request(options, serverPort, direct) {
              ...
              if (req._urlParams || req._urlReplace) {
                ...
                if (newUrl !== options.href) {
                  req.realUrl = res.realUrl = newUrl;
                  newUrl = util.parseUrl(newUrl);
                  options.path = newUrl.path;
                  options.pathname = newUrl.pathname;
                  options.href = newUrl.href;
              ...
              proxyUrl ? util.setClientId(options.headers, req.enable, req.disable, req.clientIp, isInternalProxy) : util.removeClientId(options.headers);
