...
exports.handleConnect = function(req, res) {
  ...
  pluginMgr.getTunnelReqReadPipe(req, function(reqReadStream) {
    pluginMgr.getTunnelReqWritePipe(req, function(reqWriteStream) {
      pluginMgr.getTunnelResReadPipe(req, res, function(resReadStream) {
        pluginMgr.getTunnelResWritePipe(req, res, function(resWriteStream) {
          var hasPipeStream = reqReadStream || reqWriteStream || resReadStream || resWriteStream;
          if (hasPipeStream) {
            customParser = false;
          }
          if (hasEvent || isConn) {
...
exports.handleUpgrade = function(req, res) {
  ...
  pluginMgr.getWsReqReadPipe(req, function(reqReadStream) {
    pluginMgr.getWsReqWritePipe(req, function(reqWriteStream) {
      pluginMgr.getWsResReadPipe(req, res, function(resReadStream) {
        pluginMgr.getWsResWritePipe(req, res, function(resWriteStream) {
          var hasPipeStream = reqReadStream || reqWriteStream || resReadStream || resWriteStream;
          if (hasPipeStream) {
            customParser = false;
          }
