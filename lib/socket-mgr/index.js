...
exports.handleConnect = function(req, res) {
  ...
  pluginMgr.getTunnelPipe(req, res, function(reqReadStream, reqWriteStream, resReadStream, resWriteStream) {
...
exports.handleUpgrade = function(req, res) {
  ...
  pluginMgr.getWsPipe(req, res, function(reqReadStream, reqWriteStream, resReadStream, resWriteStream) {
    var hasPipeStream = reqReadStream || reqWriteStream || resReadStream || resWriteStream;
    if (hasPipeStream) {
      customParser = false;
    }
