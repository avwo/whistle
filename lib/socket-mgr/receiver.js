...
var erMessageDeflate = require('./per-message-deflate');
...
Receiver.prototype.processPacket = function (data) {
  if (this.extensions[erMessageDeflate.extensionName]) {
    if ((data[0] & 0x30) != 0) {
...
Receiver.prototype.applyExtensions = function(messageBuffer, fin, compressed, callback) {
  var self = this;
  if (compressed) {
    this.extensions[erMessageDeflate.extensionName].decompress(messageBuffer, fin, function(err, buffer) {
      if (self.dead) return;
      if (err) {
