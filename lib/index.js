...
function proxy(conf) {
	...
	config.httpAgent = new (require('http').Agent)(agentConfig).on('free', preventThrowError);
	config.httpsAgent = new (require('https').Agent)(agentConfig).on('free', preventThrowError);
