...
function getKey(options) {
  ...
  return [options.servername, options.host, options.port || '', proxyType, options.proxyTunnelPath || '', options.cacheKey || ''].join('/');
}
...
exports.request = function(req, res, callback) {
  ...
  options.proxyTunnelPath = util.getProxyTunnelPath(req, true);
