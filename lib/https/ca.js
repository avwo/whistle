...
var createHttpsServer = require('./h2');
var pki = forge.pki;
...
exports.getSNIServer = function(listener, callback, disableH2) {
  var enableH2 = config.enableH2 && !disableH2;
  var curPort = enableH2 ? h2SniPort : sniPort;
  if (curPort) {
    return callback(curPort);
  }
  var cbList = enableH2 ? h2Callbacks : callbacks;
  if (curPort === false) {
