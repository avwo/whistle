...
var HTTPS_DIR = util.mkdir(path.join(util.LOCAL_DATA_PATH, 'https'));
...
function createCertificatePair(hostname) {
...
exports.createCertificatePair = createCertificatePair;
exports.clear = clear;