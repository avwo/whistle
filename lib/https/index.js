        ...
        util.connect(
          {
            ...
            function (err, s) {
              ...
              var key = reqSocket.localPort + ':' + reqSocket.remotePort;
              socket._w2TunnelKey = key;
              tunnelTmplData.set(key, getTunnelData(socket, clientIp, clientPort, isHttpH2));
              handlePipe();
            }
          );
      };
