...
function _handleWebsocket(socket, clientIp, clientPort, callback, wss) {
  ...
  rules.resolveRulesFile(socket, function() {
    ...
    function _pipeData() {
      ...
      util.parseRuleJson([_rules.reqHeaders, _rules.resHeaders, _rules.params],
      function(reqHeaders, resHeaders, params) {
        ...
        reqSocket.write(socket.getBuffer((forwardedFor || hasDelReq || socket.urlChanged || isInternalProxy || reqHeaders
