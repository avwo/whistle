...
module.exports = function (req, res, next) {
  ...
  if (!socket[config.CLIENT_IP_HEADER]) {
    socket[config.CLIENT_IP_HEADER] = clientIp || util.getClientIp(req);
  }
  req.clientIp = clientIp = clientIp || socket[config.CLIENT_IP_HEADER];
