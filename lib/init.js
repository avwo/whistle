...
module.exports = function(req, res, next) {
  ...
  var clientIp = util.getForwardedFor(req.headers) || socket[config.CLIENT_IP_HEAD]
    || util.getClientIp(req);
  socket[config.CLIENT_IP_HEAD] = req.clientIp = clientIp;
  socket[config.CLIENT_PORT_HEAD] = req.clientPort
    = socket[config.CLIENT_PORT_HEAD] || req.headers[config.CLIENT_PORT_HEAD] || socket.remotePort;
