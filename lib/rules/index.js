...
var rules, hosts, heads, req, res, prepend, body, append, weinre, filter;
rules = hosts = heads = req = res =prepend = body = append = weinre = filter = [];
...
function resolveBody(url) {
	return getRule(url, body);
}
