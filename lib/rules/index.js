...
var protocols = ['host', 'req', 'rule', 'res', 'weinre', 'filter', 'log', 'referer', 'auth', 'params', 'statusCode', 'redirect', 'method', 'cache', 
                 'reqDelay', 'reqSpeed', 'reqType', 'reqHeaders', 'reqBody', 'prependReq', 'appendReq', 'resDelay', 'resSpeed', 
                 'resType', 'resHeaders', 'resBody', 'prependRes', 'appendRes', 'head'];
var rules = {};
