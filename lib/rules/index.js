...
var protocols = ['host', 'req', 'rule', 'res', 'weinre', 'filter', 'log', 'referer', 'auth', 'ua', 'params', 'statusCode', 'redirect', 'method', 'cache', 
                 'reqDelay', 'reqSpeed', 'reqType', 'reqCookies', 'reqHeaders', 'reqBody', 'reqPrepend', 'reqAppend', 'resDelay', 'resSpeed', 
                 'resType', 'resCookies', 'resHeaders', 'resBody', 'resPrepend', 'resAppend', 'head'];
var rules = {};
