...
var protocols = ['host', 'req', 'rule', 'res', 'weinre', 'filter', 'log', 'referer', 'auth', 'ua', 'params', 'statusCode', 'redirect', 'method', 'cache', 
                 'reqDelay', 'reqSpeed', 'reqType', 'reqCookies', 'reqHeaders', 'reqBody', 'prependReq', 'appendReq', 'resDelay', 'resSpeed', 
                 'resType', 'resCookies', 'resHeaders', 'resBody', 'prependRes', 'appendRes', 'head'];
var rules = {};
