var protocols = ['host', 'req', 'rule', 'rulesFile', 'res', 'weinre', 'proxy', 'pac', 'filter', 'ignore', 'enable', 'disable', 'delete', 'log', 'plugin', 'exports', 'exportsUrl', 'hostname', 
                 ...
                 'reqCors', 'resCors', 'reqHeaders', 'resHeaders', 'reqPrepend', 'resPrepend', 'reqBody', 'resBody', 'reqAppend', 'resAppend', 'urlReplace', 
