var protocols = ['G', 'host', 'req', 'rule', 'res', 'weinre', 'proxy',
  'https2http-proxy', 'http2https-proxy', 'internal-proxy', 'pac', 'filter',
  'ignore', 'enable', 'disable', 'delete', 'log', 'plugin', 'exports',
  'exportsUrl', 'hostname', 'referer', 'auth', 'ua', 'etag', 'urlParams',
  'dispatch', 'params', 'resMerge', 'statusCode', 'replaceStatus',
  'redirect', 'method', 'cache', 'attachment', 'forwardedFor', 'responseFor',
  'location', 'accept', 'rulesFile', 'resScript', 'reqDelay', 'resDelay',
...
var xProtocols = ['xignore', 'xdelete', 'xenable', 'xdisable', 'xurlParams',
  'xexports', 'xexportsUrl', 'xreqMerge', 'xresMerge', 'xreqCookies',
  'xresCookies', 'xreqCors', 'xresCors', 'xreqHeaders', 'xresHeaders',
  'xreqPrepend', 'xresPrepend', 'xreqBody', 'xresBody', 'xreqAppend',
  'xresAppend', 'xurlReplace', 'xreqReplace', 'xresReplace', 'xreqWrite',
  'xresWrite', 'xreqWriteRaw', 'xresWriteRaw', 'xcssAppend', 'xhtmlAppend',
  'xjsAppend', 'xcssBody', 'xhtmlBody', 'xjsBody', 'xcssPrepend',
  'xhtmlPrepend', 'xjsPrepend'
];
var RULE_RE = /^(?:|x|xs)(?:file|rawfile|dust|tpl|jsonp):$/;
var resProtocols = ['res', 'filter', 'disable', 'ignore', 'replaceStatus',
  'cache', 'attachment', 'delete', 'resMerge', 'location', 'resDelay',
...
exports.isXProtocol = function (name) {
  return xProtocols.indexOf(name) !== -1;
};
