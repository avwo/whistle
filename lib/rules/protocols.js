var protocols = ['G', 'style', 'host', 'rule', 'pipe', 'weinre', 'proxy',
  ...
  'referer', 'auth', 'ua', 'urlParams', 'params', 'resMerge', 'replaceStatus',
  ...
  'reqHeaders', 'resHeaders', 'trailers', 'reqPrepend', 'resPrepend', 'reqBody',
  ...
  'cssPrepend', 'htmlPrepend', 'jsPrepend', 'cipher', 'sniCallback'
];
...
var pureResProtocols = ['replaceStatus', 'cache', 'attachment', 'resMerge', 'resDelay', 
'resSpeed', 'resType', 'resType', 'resCharset', 'resCookies', 'resCors',
'resHeaders', 'trailers', 'resPrepend', 'resBody', 'resAppend', 'resReplace',
'resWrite', 'resWriteRaw', 'cssAppend', 'htmlAppend', 'jsAppend', 'cssBody',
'htmlBody', 'jsBody', 'cssPrepend', 'htmlPrepend', 'jsPrepend', 'responseFor'
];
var resProtocols = ['filter', 'enable', 'disable', 'ignore', 'style', 'delete', 'headerReplace'].concat(pureResProtocols);
...
exports.multiMatchs = [
  'G', 'ignore', 'enable', 'filter', 'disable', 'plugin', 'delete', 'style', 'trailers',
  ...
  'cssBody', 'htmlPrepend', 'jsPrepend', 'cssPrepend', 'rulesFile', 'resScript'
];
