var protocols = ['host', 'req', 'rule', 'rulesFile', 'res', 'weinre', 'proxy', 'https2http-proxy', 'http2https-proxy', 'pac', 'filter', 'ignore', 'enable', 'disable', 'delete', 'log',
                 'plugin', 'exports', 'exportsUrl', 'hostname', 'referer', 'auth', 'ua', 'etag', 'urlParams', 'dispatch', 'params', 'statusCode', 'replaceStatus',
