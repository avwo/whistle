var protocols = ['host', 'req', 'rule', 'res', 'weinre', 'proxy', 'https2http-proxy', 'http2https-proxy', 'internal-proxy', 'pac', 'filter', 'ignore', 'enable',
                 ...
                 'redirect', 'method', 'cache', 'attachment', 'forwardedFor', 'location', 'accept', 'rulesFile', 'resScript', 'reqDelay', 'resDelay', 'reqSpeed', 'resSpeed', 'reqType', 'resType', 'reqCharset',
