var protocols = ['host', 'req', 'rule', 'res', 'weinre', 'proxy', 'socks', 'pac', 'filter', 'disable', 'delete', 'log', 'plugin', 'exports', 'exportsUrl', 'hostname', 
                 'referer', 'auth', 'ua', 'etag', 'urlParams', 'dispatch', 'params', 'statusCode', 'replaceStatus', 'redirect', 'method', 'cache', 'attachment', 
                 'location', 'accept', 'reqDelay', 'resDelay', 'reqSpeed', 'resSpeed', 'reqType', 'resType', 'reqCharset', 'resCharset', 'reqCookies', 'resCookies', 
                 'reqCors', 'resCors', 'reqHeaders', 'resHeaders', 'reqPrepend', 'resPrepend', 'reqBody', 'resBody', 'reqAppend', 'resAppend', 'head', 'urlReplace', 
                 'reqReplace', 'resReplace', 'reqWrite', 'resWrite', 'reqWriteRaw', 'resWriteRaw', 'css', 'html', 'js'];
...
function contains(name) {
  ...
  name += ':';
  return isWebsocketProtocol(name) || isWebProtocol(name) || isProxyProtocol(name) || isFileProxy(name) || name == 'tunnel:';
}
