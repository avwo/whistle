...
exports.multiMatchs = [
  'ignore', 'enable', 'filter', 'disable', 'plugin',
  'urlParams', 'reqHeaders', 'reqCors', 'reqCookies',
  'params', 'resHeaders', 'resCors', 'resCookies', 'reqReplace', 'urlReplace',
  'resReplace', 'resMerge', 'reqBody', 'reqPrepend', 'reqAppend', 'resBody',
  'resPrepend', 'resAppend', 'htmlAppend', 'jsAppend', 'cssAppend',
