var protocols = ['host', 'req', 'rule', 'res', 'weinre', 'pac', 'filter', 'disable', 'delete', 'log', 'plugin', 'exports', 'exportsUrl', 'hostname', 'referer', 'auth', 'ua', 'etag',  
                 ...
                 'reqPrepend', 'resPrepend', 'reqBody', 'resBody', 'reqAppend', 'resAppend', 'head', 'urlReplace', 'reqReplace', 'resReplace', 'reqWrite', 'resWrite', 'reqWriteRaw', 
                 'resWriteRaw', 'css', 'html', 'js'];
