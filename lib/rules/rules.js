...
var TPL_VAR_RE = /\$\{(url|req|res)(?:\.([\w.]+))\}/g;
var SEP_RE = /^[?/]/;
var CONTROL_RE = /[\u001e\u001f\u200e\u200f\u200d\u200c\u202a\u202d\u202e\u202c\u206e\u206f\u206b\u206a\u206d\u206c]+/g;
...
function renderTpl(rule, req) {
  ...
  rule.isTpl = false;
  matcher = matcher.replace(TPL_RE, function(all, proto, value) {
    rule.isTpl = true;
    return (proto || '') + value.slice(1, -1);
  });
  return matcher;
}

function resolveVar(rule, vals) {
  var matcher = renderTpl(rule);
...
function resolveRuleList(req, list, vals, index) {
  ...
  var getExactRule = function(relPath) {
    origMatcher = resolveVar(rule, vals);
