...
function parseRule(rulesMgr, pattern, matcher, raw, root, options) {
  ...
  if (!list) {
    ...
    var opts = isHost(util.removeProtocol(matcher, true));
    if (opts) {
      matcher = 'host://' + opts.host;
      port = opts.port;
    }
  }
  var rule = {
...
proto.resolveBodyFilter = function(req) {
  return req.isPluginReq ? null : getRule(req, req._bodyFilters || this._rules._bodyFilters);
};
