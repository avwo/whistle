...
var pluginProtocols = ['enable', 'disable', 'plugin', 'rule', 'reqHeaders', 'auth', 'referer', 'forwardedFor'];
var proxyProtocols = ['enable', 'disable', 'plugin', 'reqHeaders', 'auth', 'referer', 'forwardedFor'];
