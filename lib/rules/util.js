...
function addRulesFile(file, data, groupName) {
...
function moveRulesTo(fromName, toName, clientId, group) {
  if (rulesStorage.moveTo(fromName, toName, group)) {
...
exports.rules = {
  ...
  add: function (file, data, clientId, groupName) {
    if (file !== 'Default' && addRulesFile(file, data, groupName)) {
      config.setModified(clientId, true);
...
function addValuesFile(file, data, groupName) {
...
exports.values = {
  ...
  add: function (file, data, clientId, groupName) {
    if (addValuesFile(file, data, groupName)) {
      config.setModified(clientId);
