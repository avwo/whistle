...
var queryIndex = pluginPath.indexOf('?');
var pluginQuery = {};
if (queryIndex != -1) {
	pluginQuery = qs.parse(pluginPath.substring(queryIndex + 1));
	pluginPath = pluginPath.substring(0, queryIndex);
}
