...
var REQ_FROM_HEADER = comUtil.WHISTLE_REQ_FROM_HEADER;
...
pluginMgr.getResRules = function(req, res, callback) {
  getRulesMgr('resRules', req, res, function(resRulesMgr) {
    var resRules = resRulesMgr && resRulesMgr.resolveRules(req.fullUrl);
    if (resRules) {
