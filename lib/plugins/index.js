...
pluginMgr.getWsPipe = function(req, res, callback) {
  ...
  getWsReqReadPipe(req, function(reqReadStream) {
    getWsReqWritePipe(req, function(reqWriteStream) {
      getWsResReadPipe(req, res, function(resReadStream) {
        getWsResWritePipe(req, res, function(resWriteStream) {
          callback(reqReadStream, reqWriteStream, resReadStream, resWriteStream);
        });
      });
    });
  });
...
pluginMgr.getTunnelPipe = function(req, res, callback) {
  getTunnelReqReadPipe(req, function(reqReadStream) {
    getTunnelReqWritePipe(req, function(reqWriteStream) {
      getTunnelResReadPipe(req, res, function(resReadStream) {
        getTunnelResWritePipe(req, res, function(resWriteStream) {
          callback(reqReadStream, reqWriteStream, resReadStream, resWriteStream);
        });
      });
    });
