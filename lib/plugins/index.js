    ...
    if (!pkg || pkg.path != newPkg.path || pkg.mtime != newPkg.mtime) {
      ...
      fse.readJson(newPkg.pkgPath, function(err, result) {
        if (result && result.version) {
          ...
          var hintResult = util.getHintList(conf);
          ...
          newPkg.hintUrl = hintResult ? undefined : util.getCgiUrl(conf.hintUrl);
          newPkg.hintList = hintResult && hintResult.hintList;
          newPkg.hintPosition = hintResult && hintResult.hintPosition,
          newPkg.hintOffset = hintResult && hintResult.hintOffset,
