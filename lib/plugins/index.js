...
var HTTPS_FLAG_HEADER = 'x-whistle-https';
var PROTOCOL_RE = /^([\da-z]):/i;
var INTERVAL = 6000;
...
pluginMgr.HTTPS_FLAG_HEADER = HTTPS_FLAG_HEADER;
...
pluginMgr.getPluginByRuleUrl = function(ruleUrl) {
	if (PROTOCOL_RE.test(ruleUrl)) {
		return plugins[RegExp.$1];
	}
};
