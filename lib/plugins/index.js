...
pluginMgr.getReqEncoder = getPipe('reqEncoder', 'REQ_ENCODER');
pluginMgr.getReqDecoder = getPipe('reqDecoder', 'REQ_DECODER');
pluginMgr.getResEncoder = getPipe('resEncoder', 'RES_ENCODER');
pluginMgr.getResDecoder = getPipe('resDecoder', 'RES_DECODER');
