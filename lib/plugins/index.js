...
function getRulesHeaders(req, rules, headers) {
  headers = headers || extend({}, req.headers);
...
pluginMgr.getRulesHeaders = getRulesHeaders;
...
function getOptions(req, res, type) {
  ...
  options.headers = headers = getRulesHeaders(req, rules, headers);
