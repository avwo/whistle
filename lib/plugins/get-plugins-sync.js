    ...
    try {
      ...
      if (pkg && pkg.version) {
        ...
        var plugin = {
          ...
          hintUrl: hintResult ? undefined : util.getCgiUrl(conf.hintUrl),
          hintList: hintResult && hintResult.hintList,
          hintPosition: hintResult && hintResult.hintPosition,
          hintOffset: hintResult && hintResult.hintOffset,
