...
var parseInfo = function(req) {
  var oReq = req.orginalReq = {};
  var oRes = req.orginalRes = {};
  ...
  oReq.method = getValue(req, pluginOpts.METHOD_HEADER);
  oReq.clientIp = getValue(req, pluginOpts.CLIENT_IP_HEADER) || '127.0.0.1';
