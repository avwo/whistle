...
var getServer = require('E:/workbench/workspace/github/hagent').create(null, 40500);
...
module.exports = function(options, callback) {
  ...
  var port, statsPort, uiPort, rulesPort, resRulesPort, statusPort, tunnelRulesPort, tunnelPort;
  var count = 0;
  ...
  var startStatsServer = execPlugin.statsServer;
