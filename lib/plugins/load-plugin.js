...
function createSocket(opts, cb, isHttp) {
  ...
  if (net.isIP(opts.clientIp)) {
    headers['x-forwarded-for'] = net.isIP(opts.clientIp);
  }
  if (opts.clientPort > 0 && opts.clientPort < 65536) {
    headers['x-whistle-client-port'] = opts.clientPort;
  }
