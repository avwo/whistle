...
var sessionOpts, sessionPending;
var rulesOpts, rulesPending;
var valuesOpts, valusPending;
var reqCallbacks = {};
var resCallbacks = {};
var MAX_LENGTH = 100;
var TIMEOUT = 300;
var timer, pluginOpts, storage;
var noop = function() {};
...
var retryRequest = function(time) {
  if (!timer) {
    timer = setTimeout(requestSessions, time || TIMEOUT);
  }
};
...
module.exports = function(options, callback) {
  ...
  sessionOpts = url.parse('http://127.0.0.1:' + config.uiport + '/cgi-bin/get-session?');
