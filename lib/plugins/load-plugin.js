...
var appendTrailers = function(_res, res) {
  _res.on('end', function() {
    var trailers = _res.trailers;
    if (!res.chunkedEncoding || isEmptyObject(trailers)) {
      return;
    }
      ...
      server.on('request', function(req, res) {
        ...
        case PLUGIN_HOOKS.HTTP:
          if (httpServer) {
            ...
            req.appendTrailers = res.appendTrailers = function(_res) {
              appendTrailers(_res, res);
            };
