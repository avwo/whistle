...
var initReq = function(req, res, isServer) {
  ...
  req.fromComposer = oReq.fromComposer = req.headers[pluginOpts.config.REQ_FROM_HEADER] === 'W2COMPOSER';
  ...
  if (req.headers['x-whistle-non-sni-req']) {
    delete req.headers['x-whistle-non-sni-req'];
  } else {
    req.useSNI = oReq.useSNI = req.isSNI = oReq.isSNI = true;
  }
