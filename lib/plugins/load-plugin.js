...
module.exports = function(options, callback) {
  ...
  var initServers = function(_ctx) {
    ...
    getServer(function(server, _port) {
      var maxWsPayload, maxTunnelPayload;
      ...
      var setMaxTunnelPayload = function(payload) {
        maxTunnelPayload = parseInt(payload, 10) || 0;
      };
      ...
      if (startTunnelReqRead) {
        ...
        tunnelReqRead.setMaxTunnelPayload = setMaxTunnelPayload;
      ...
      if (startTunnelReqWrite) {
        ...
        tunnelReqWrite.setMaxTunnelPayload = setMaxTunnelPayload;
      ...
      if (startTunnelResWrite) {
        ...
        tunnelResWrite.setMaxTunnelPayload = setMaxTunnelPayload;
