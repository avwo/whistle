...
var SPEC_HOST_RE = /.whistle-policy-(internal|capture|tunnel|connect)(?:-([a-z\d]+))?s$/;
...
function createSocket(opts, cb) {
  ...
  if (opts.mark && typeof opts.mark === 'string') {
    headers['x-whistle-plugin-mark'] = opts.mark;
  }
  if (opts.isInternal) {
...
module.exports = function(options, cb) {
  ...
  getServer(function(server, port) {
    ...
    socketProto.connect = function() {
      ...
      connect.call(this, tempServerOpts, cb);
