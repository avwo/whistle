...
pluginsPath = process.env && process.env.WHISTLE_PLUGINS_PATH;
if (pluginsPath && typeof pluginsPath == 'string') {
	pluginsPath = formatPath(path.join(pluginsPath, 'node_modules'));
