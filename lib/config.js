...
exports.extend = function (newConf) {
  ...
  if (newConf) {
    ...
    config.projectPluginPaths = getPaths(newConf.projectPluginPaths || newConf.projectPluginsPath || newConf.projectPluginPath);
    ...
    if (config.projectPluginPaths) {
      config.prePluginsPath = config.projectPluginPaths.concat(config.customPluginPaths);
    } else if (config.customPluginPaths) {
      config.prePluginsPath = config.customPluginPaths;
    }
