...
var tunnel = require('E:/workbench/workspace/github/hagent').agent;
...
var pluginMgr;
var variableProperties = ['port', 'uiport', 'encrypted', 'ATS', 'sockets', 'timeout', 'dataDirname', 'storage', 'baseDir',
