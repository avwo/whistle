...
var variableProperties = ['port', 'ATS', 'sockets', 'timeout', 'dataDirname', 'storage', 'cacheFiles',
'username', 'password', 'uipath', 'debug', 'debugMode', 'localUIHost', 'extra', 'rules', 'values', 'baseDir'];
...
exports.extend = function extend(newConf) {
  ...
  var baseDir = config.baseDir ? path.resolve(config.baseDir, '.whistle') : getDataDir(config.dataDirname);
