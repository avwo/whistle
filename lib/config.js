...
var variableProperties = ['port', 'encrypted', 'ATS', 'sockets', 'timeout', 'dataDirname', 'storage', 'baseDir',
'username', 'password', 'uipath', 'debug', 'debugMode', 'localUIHost', 'extra', 'rules', 'values', 'dnsCache'];
...
exports.extend = function extend(newConf) {
  ...
  var isLocalUIUrl = function(url) {
    ...
    return LOCAL_UI_HOST_LIST.indexOf(host) != -1 || NOHOST_RE.test(host);
  };
