...
config.enableH2 = disableAgent || (version[0] == 10 && version[1] >= 16);
  ...
  if (newConf) {
    ...
    if (typeof newConf.mode === 'string') {
      ...
      mode.forEach(function(m) {
        if (/^(pureProxy|debug|nohost|strict|multiEnv|multienv|encrypted|noGzip)$/.test(m)) {
          config[m] = true;
